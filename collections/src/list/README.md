...
- List é uma coleção ordenada que permite a inclusão de elementos duplicados
- Permite adicionar ou remover elementos
- A interface List ornece métodos úteis para adicionar elementos ou remover elementos com base nos índices
- A classe Collections fornece algoritmos úteis para manipulação de List, como ordenação(sort), embaralhamento(snuffle) e etc

> ArrayList:
> - Fornece acesso rápido aos elementos por meio de índices
> - Adicionar ou remover elementos pode ser mais lento

> LinkedList:
> - Cada elemento contém referência para o elemento anterior e próximo da lista
> - Fornece eficiência na adição ou remoção no início ou final da lista
> - Acesso aos elementos por meio de índices é mais lento

> Vector:
> - O Vector é uma implementação antiga da interface List que é semelhante ao ArrayList, mas é sincronizada, ou seja, é thread-safe.

## Exercícios:

1. [Operações Básicas com List](https://github.com/maitebecker/java-collections/tree/main/collections/src/list/operacoesBasicas)
2. [Pesquisa em List](https://github.com/maitebecker/java-collections/tree/main/collections/src/list/pesquisa)
3. [Ordenação nas List](https://github.com/maitebecker/java-collections/tree/main/collections/src/list/ordenacao)
